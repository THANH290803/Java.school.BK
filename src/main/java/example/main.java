...
//
//
//    public static ArrayList<Phone> Menu() {
//        System.out.println("--------------------------Menu-------------------");
//        System.out.println("1-------------------------Add phone--------------");
//        System.out.println("2-------------------Edit phone by chip-----------");
//        System.out.println("3------------------Delete phone by chip----------");
...
//            case 6:
//
//                 ArrayList<Phone> timTheoNSX;
//                ArrayList<Phone> resultsArrayList = new ArrayList<>();
//
//                for (Phone dienThoai : arr) {
//                    if (!dienThoai.getManufacturer().contains(Manufacturer)) {
//
//                    }
